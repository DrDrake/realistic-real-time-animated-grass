...
namespace Uncut
{
    internal class SampleJupiterController : SlimSceneController
    {
        ...
        protected override void OnResourceLoad()
        {
            ...
            jupiterMesh = new SimpleModel(Context10.Device, Asset.File("SimpleModel10.fx"), Asset.File("jupiter.SMD"), Asset.File("jupiter.jpg"));
