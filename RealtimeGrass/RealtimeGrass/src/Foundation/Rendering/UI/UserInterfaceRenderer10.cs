...
using RealtimeGrass.Rendering.Primitive;
...
namespace RealtimeGrass.Rendering.UI
{
    ...
    public class UserInterfaceRenderer10 : UserInterfaceRenderer
    {
        ...
        public UserInterfaceRenderer10(D3D.Device device, int width, int height)
        {
            ...
            /*
             * Ressourcen müssen als Embedded Resources konfiguriert sein!
             * Beispiel:
             * Klick auf Ressources/UserInterface.10.fx, unten rechts im Properties-Fenster (Rechtsklick > Properties) bei "Build Action" auf "Embedded Ressource" stellen.
             * 

            try
            {
                Stream stream = assembly.GetManifestResourceStream("RealtimeGrass.Ressources.shader.UserInterface10.fx");
                if (stream == null)
                {
                    string[] resourceNames = this.GetType().Assembly.GetManifestResourceNames();
                    ManifestResourceInfo info = assembly.GetManifestResourceInfo("UserInterface10.fx");
            ...
            */
            using (Stream stream = assembly.GetManifestResourceStream("RealtimeGrass.Resources.shader.UserInterface10.fx"))
