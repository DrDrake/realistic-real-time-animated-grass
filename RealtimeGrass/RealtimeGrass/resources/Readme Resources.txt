...
z.b. in UserInterfaceRenderer10.cs:
	using (Stream stream = assembly.GetManifestResourceStream("RealtimeGrass.Resources.UserInterface10.fx"))
Der angegebene Pfad "RealtimeGrass.Resources.UserInterface10.fx" ist nicht der Pfad zur Datei auf dem Dateisystem, sondern in welchem Ordner die Datei im Visual Studio Projekt eingefügt ist.
